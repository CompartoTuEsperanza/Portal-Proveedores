...
export default function DashboardHeader() {
  ...
  return (
    <header className="hidden lg:flex items-center justify-between bg-white/80 backdrop-blur-sm border-b border-rose-100/40 px-6 py-3 animate-card-stagger stagger-1">
      {/* Left: Welcome + Date */}
      <div className="flex items-center gap-4">
        <div className="flex flex-col">
          <h1 className="text-sm font-medium text-rose-800/70 leading-tight">
            Bienvenido,{" "}
        ...
        <div className="flex items-center gap-2">
          ...
          <span className="text-xs text-emerald-700 font-medium">En línea</span>
        </div>
      </div>
      ...
      <div className="flex items-center gap-4">
        ...
        <button
          ...
          className="flex items-center gap-2 px-3 py-2 text-sm text-rose-900/70 hover:text-red-700 hover:bg-red-50 rounded-md transition-all duration-200 cursor-pointer whitespace-nowrap hover:-translate-y-0.5 hover:shadow-sm active:scale-95"
        >
