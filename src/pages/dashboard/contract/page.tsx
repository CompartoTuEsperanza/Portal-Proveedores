...
export default function Contract() {
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="bg-white rounded-lg border border-rose-100/60 p-6 md:p-8 space-y-6">
        {/* Contract Header */}
        ...
        <div className="space-y-4">
          ...
          <div className="space-y-3">
            <div className="flex items-start gap-3 p-3 border border-rose-50/60 rounded-md">
              <span className="w-6 h-6 flex items-center justify-center bg-rose-50/50 rounded text-rose-800 flex-shrink-0 text-xs font-bold">1</span>
              <div>
            ...
            <div className="flex items-start gap-3 p-3 border border-rose-50/60 rounded-md">
              <span className="w-6 h-6 flex items-center justify-center bg-rose-50/50 rounded text-rose-800 flex-shrink-0 text-xs font-bold">2</span>
              <div>
            ...
            <div className="flex items-start gap-3 p-3 border border-rose-50/60 rounded-md">
              <span className="w-6 h-6 flex items-center justify-center bg-rose-50/50 rounded text-rose-800 flex-shrink-0 text-xs font-bold">3</span>
              <div>
            ...
            <div className="flex items-start gap-3 p-3 border border-rose-50/60 rounded-md">
              <span className="w-6 h-6 flex items-center justify-center bg-rose-50/50 rounded text-rose-800 flex-shrink-0 text-xs font-bold">4</span>
              <div>
            ...
            <div className="flex items-start gap-3 p-3 border border-rose-50/60 rounded-md">
              <span className="w-6 h-6 flex items-center justify-center bg-rose-50/50 rounded text-rose-800 flex-shrink-0 text-xs font-bold">5</span>
              <div>
