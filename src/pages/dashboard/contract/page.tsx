          ...
          <div className="space-y-3">
            ...
            <div className="flex items-start gap-3 p-3 bg-black/30 border border-rose-300/25 rounded-md backdrop-blur-sm">
              ...
              <div>
                ...
                <p className="text-xs font-medium text-rose-200/85 mt-0.5">Los pagos se realizarán dentro de los 15 días hábiles posteriores a la recepción y aprobación del lote. El método de pago será transferencia bancaria a la cuenta designada.</p>
              </div>
            </div>
            <div className="flex items-start gap-3 p-3 bg-black/30 border border-rose-300/25 rounded-md backdrop-blur-sm">
