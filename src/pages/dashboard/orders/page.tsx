...
export default function Orders() {
  ...
  return (
    <div className="space-y-6">
      <div>
        <h2 className="text-xl font-semibold text-rose-950">Órdenes y Solicitudes</h2>
          ...
          <table className="w-full text-sm">
            <thead>
              <tr className="bg-white/50 border-b border-rose-100/60">
                <th className="text-left py-3 px-4 text-rose-900/70 font-semibold">ID Orden</th>
                ...
                <th className="text-right py-3 px-4 text-rose-900/70 font-semibold">Total</th>
              </tr>
            </thead>
            <tbody>
              {myOrders.map((order) => (
                <tr key={order.id} className="border-b border-rose-50/60 hover:bg-white/40 transition-colors">
                  <td className="py-3 px-4 font-mono text-xs text-rose-800/60">{order.id}</td>
                  <td className="py-3 px-4 text-rose-900/70">{order.date}</td>
